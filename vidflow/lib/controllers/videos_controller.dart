...
class VideosController extends GetxController {
  ...
  Future<void> create() async {
    final Video video = Video(thumbURL:textVideoThumbNailController.text,
    title: textVideoTitleController.text,userId: 2);

    try{
      Response<void> response = await  videosApi.create(video, "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImV1QG1tbS5jb20iLCJpYXQiOjE3MjEyMDI4ODUsImV4cCI6MTcyMTIwNjQ4NSwic3ViIjoiMiJ9.HNdmmB_pBYp7xPZrTkiwjeHzMKlW-iW2h7B-KFOBNAQ");
